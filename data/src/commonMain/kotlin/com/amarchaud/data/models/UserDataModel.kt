...
data class LocationDataModel(
    ...
    @Serializable(with = com.amarchaud.data.adapters.OneStringSerializer::class)
    val postcode: com.amarchaud.data.adapters.ForceString? = null, // problem with api, sometimes Int, sometimes String
...
data class DobDataModel(
    @Serializable(with = com.amarchaud.data.adapters.LocalDateTimeSerializer::class)
    @SerialName("date")
